...
names="rstmap_angular_nginx_${cur_ver}"
from_release="rstmap_angular_${cur_ver}"
...
docker build --build-arg RELEASE=${from_release} --progress=plain -t ${names} . -f ./Dockerfile_nginx
